...
R script to map gene name to each KEGG pathways and Modules. This code can help to have gene name in one column and KEGG pathway ID in another column. 
Another data set that generates is genes and their  KEGG modules
Several intermediate dataset also will be generated during the process that might be of interest, like a dataset on modules, their definition, and pathways involved in that module.
